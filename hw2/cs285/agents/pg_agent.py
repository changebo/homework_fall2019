...
class PGAgent(BaseAgent):
    ...
    def _discounted_return(self, rewards):
        ...
        sum_of_discounted_rewards = sum([self.gamma ** t * rewards[t] for t in range(len(rewards))])
    ...
    def _discounted_cumsum(self, rewards):
        ...
        for start_time_index in range(len(rewards)): 
            ...
            sum_discounted_rtg = sum([self.gamma ** (t - start_time_index) * rewards[t] for t in range(start_time_index, len(rewards))])
